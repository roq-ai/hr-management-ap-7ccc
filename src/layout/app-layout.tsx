...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'owner', 'hr-manager', 'employee'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Employees', path: '/employees', entity: 'employee', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    {
      name: 'Hr Managers',
      path: '/hr-managers',
      entity: 'hr_manager',
    ...
    { name: 'Owners', path: '/owners', entity: 'owner', service: AccessServiceEnum.PROJECT, icon: FiKey },
    {
    ...
    { name: 'Salaries', path: '/salaries', entity: 'salary', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    { name: 'Schedules', path: '/schedules', entity: 'schedule', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
