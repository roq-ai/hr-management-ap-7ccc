    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <TextInput
            error={formik.errors.hr_manager_department}
            label={'Hr Manager Department'}
            props={{
              name: 'hr_manager_department',
              placeholder: 'Hr Manager Department',
              value: formik.values?.hr_manager_department,
          ...
          <NumberInput
            label="Hr Manager Salary"
            formControlProps={{
              id: 'hr_manager_salary',
              isInvalid: !!formik.errors?.hr_manager_salary,
            }}
            name="hr_manager_salary"
            error={formik.errors?.hr_manager_salary}
            value={formik.values?.hr_manager_salary}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('hr_manager_salary', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
