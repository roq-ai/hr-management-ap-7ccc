...
import { useAdministratorFindFirst, useRoqClient } from 'lib/roq';
...
function AdministratorViewPage() {
  ...
  const { data, error, isLoading } = useAdministratorFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('administrator', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/administrators/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Administrator Department" text={data?.administrator_department} />

                <FormListItem label="Job Title" text={data?.job_title} />

                <FormListItem label="Administrator Salary" text={data?.administrator_salary} />
