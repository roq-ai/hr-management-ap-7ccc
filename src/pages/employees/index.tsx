...
export function EmployeeListPage(props: EmployeeListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['job_title.contains', 'employee_department.contains'],
          ...params.filters,
        },
        'employee',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'employee_salary', header: 'employee_salary', accessorKey: 'employee_salary' },
    { id: 'employee_department', header: 'Employee Department', accessorKey: 'employee_department' },
