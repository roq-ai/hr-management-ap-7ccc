      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'employee_salary',
              isInvalid: !!formik.errors?.employee_salary,
            }}
            name="employee_salary"
            error={formik.errors?.employee_salary}
            value={formik.values?.employee_salary}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('employee_salary', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />

          <TextInput
            error={formik.errors.employee_department}
            label={'Employee Department'}
            props={{
              name: 'employee_department',
              placeholder: 'Employee Department',
              value: formik.values?.employee_department,
              onChange: formik.handleChange,
            }}
          />
