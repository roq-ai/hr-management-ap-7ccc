...
import { useOwnerFindFirst, useRoqClient } from 'lib/roq';
...
function OwnerViewPage() {
  ...
  const { data, error, isLoading } = useOwnerFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('owner', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/owners/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  ...
                  text={data?.established_date ? format(data?.established_date, 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Industry" text={data?.industry} />

                <FormListItem label="Total Employees" text={data?.total_employees} />
