  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'administrator.count', 'employee.count', 'hr_manager.count', 'owner.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('administrator', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.administrator,
        }
      : null,
    hasAccess('employee', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('hr_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'hr_manager',
          header: 'Hr Manager',
          accessorKey: 'hr_manager',
          cell: ({ row: { original: record } }: any) => record?._count?.hr_manager,
        }
      : null,
    hasAccess('owner', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Owner',
          accessorKey: 'owner',
          cell: ({ row: { original: record } }: any) => record?._count?.owner,
        }
      : null,
